...
<main>
  ...
  <div class="cards-container">
    <div class="card" onclick="window.location.href='prenotazioni_produttore.php'">
      <h2>Prenotazioni</h2>
      <p>Visualizza tutte le prenotazioni ricevute</p>
    </div>

    <div class="card" onclick="window.location.href='manutenzione_strumenti.php'">
      <h2>Manutenzione</h2>
      <p>Gestisci la manutenzione della sala</p>
    </div>

    <div class="card" onclick="window.location.href='archivio_produttore.php'">
      <h2>Archivio Editing</h2>
      <p>Gestisci l’archivio delle sessioni di editing</p>
    </div>
  </div>
</main>
