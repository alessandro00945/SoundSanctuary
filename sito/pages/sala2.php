...
$vintage_instruments = [
  [
    "id" => "29",
    "nome" => "Akai",
    "descrizione" => "Campionatore e drum machine iconico degli anni '80, fondamentale per il suono Hip-Hop old school.",
    "immagine" => "../images/akai.jpg"
  ],
  [
    "id" => "30",
    "nome" => "Sonor - Vintage Set 3 Pezzi BD 22",
    "descrizione" => "Batteria suonata dal leggendario Dave Grohl.",
    "immagine" => "../images/sonor.jpg"
  ],
...
<head>
  <meta charset="UTF-8" />
  <title>Sala Registrazione Rap/Hip-Hop | Sound Sanctuary</title>
  <style>
    body {
      margin: 0; 
...
<div class="container">
  <h1>🎙️ Sala di Registrazione Rap/Hip-Hop</h1>
  ...
  <form action="prenota_sala.php" method="POST">
    <input type="hidden" name="sala" value="Sala Rap/Hip-Hop">
    ...
    <div class="form-section">
      ...
      <div class="checkbox-group">
        <label><input type="checkbox" name="equipment[]" value="23"> Microfono</label>
        <label><input type="checkbox" name="equipment[]" value="24"> Chitarra elettrica</label>
        <label><input type="checkbox" name="equipment[]" value="25"> Basso</label>
        <label><input type="checkbox" name="equipment[]" value="26"> Batteria</label>
        <label><input type="checkbox" name="equipment[]" value="27"> Tastiere</label>
        <label><input type="checkbox" name="equipment[]" value="28"> Sintetizzatori</label>
      </div>
    </div>
