...
$produttoreResponsabile = "Butch.Vig";

// Catalogo strumenti vintage associati alla sala
$vintage_instruments = [
[
    "id" => "20",
    "nome" => "Gibson Limited Edition Vampire Blood Moon Explorer 2011 Ebony/Red",
    "descrizione" => "Chitarra elettrica vintage con suono caldo e classico.",
    "immagine" => "../images/gibson.jpeg"
  ],
  [
    "id" => "21",
    "nome" => "Neve 1073",
    "descrizione" => "Preamp microfonico vintage leggendario.",
    "immagine" => "../images/preamp.jpg"
  ],
  [
    "id" => "22",
    "nome" => "Ludwig Classic Maple",
    "descrizione" => "Batteria vintage con suono potente.",
    "immagine" => "../images/ludwig.jpg"
  ],
];
?>
...
<div class="container">
  <h1>🎙️ Sala di Registrazione Rock</h1>
  ...
  <form action="prenota_sala.php" method="POST">
    <input type="hidden" name="sala" value="Sala Rock">
    ...
    <div class="form-section">
      ...
      <div class="checkbox-group">
        <label><input type="checkbox" name="equipment[]" value="13"> Microfono</label>
        <label><input type="checkbox" name="equipment[]" value="14"> Chitarra elettrica</label>
        <label><input type="checkbox" name="equipment[]" value="15"> Basso elettrico</label>
        <label><input type="checkbox" name="equipment[]" value="16"> Batteria</label>
        <label><input type="checkbox" name="equipment[]" value="17"> Tastiere</label>
        <label><input type="checkbox" name="equipment[]" value="18"> Pianoforte</label>
        <label><input type="checkbox" name="equipment[]" value="19"> Sassofono</label>
      </div>
    </div>
