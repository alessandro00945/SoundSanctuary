...
$produttoreResponsabile = "Paolo.Fresu";

// Catalogo strumenti vintage associati alla sala
$vintage_instruments = [
  [
    "id" => "45",
    "nome" => "Eastar AS-II E-Flat sassofono",
    "descrizione" => "Sassofono anni 70.",
    "immagine" => "../images/sa.webp"
  ],
  [
    "id" => "46",
    "nome" => "Fender American Vintage Ii 1966 Jazz Bass Ss Rw Olympic White",
    "descrizione" => "Chitarra 1966 white",
    "immagine" => "../images/fe.jpg"
  ],
...
<div class="container">
  <h1>🎙️ Sala di Registrazione Jazz</h1>
  ...
  <form action="prenota_sala.php" method="POST">
    <input type="hidden" name="sala" value="Sala Jazz">
    ...
    <div class="form-section">
      ...
      <div class="checkbox-group">
        <label><input type="checkbox" name="equipment[]" value="39"> Microfono</label>
        <label><input type="checkbox" name="equipment[]" value="40"> Tromba</label>
        <label><input type="checkbox" name="equipment[]" value="41"> Trombone</label>
        <label><input type="checkbox" name="equipment[]" value="42"> Clarinetto</label>
        <label><input type="checkbox" name="equipment[]" value="43"> Sassofono</label>
        <label><input type="checkbox" name="equipment[]" value="44"> Pianoforte</label>
      </div>
    </div>
